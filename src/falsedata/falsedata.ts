// 热搜词
export var falseHotWord: StoreStats.falseHotWord[] = [{
  "search_word": "辣鸭脖",
  "title": "辣鸭脖"
},
{
...
// 订单信息
export var falseOrder: StoreStats.falseOrder[] = [{
...
// 商家简略信息
export var falseBussinessbrief: StoreStats.falseBussinessbrief[] = [{
  "shop_name": "上沙麦当劳", // 店名
  "id": "s10001",
  "path": "/s10001",
  "shop_rating": 4.7, // 店评分
...
// 商店信息
export var falseBussinessInfo: StoreStats.falseBussinessInfo = {
  "s10001": {
    "shop_name": "上沙麦当劳", // 店名
    "id": "s10001",
