...
export function remChange (): any {
    var resizeEvt: any = 'orientationchange' in window ? 'orientationchange' : 'resize';
    var widthProportion = function (): number {
        var doc: any = document.body || document.documentElement;
        var p: number = doc.clientWidth;
        return p / 10;
    };
    var changePage = function (): any {
